...
@php
    ...
    $paymentOptions = [
        ['code' => 'qris', 'title' => 'QRIS', 'caption' => 'QR Code Standar Pembayaran Nasional'],
        ['code' => 'bca_va', 'title' => 'BCA Virtual Account', 'caption' => 'Pembayaran otomatis terdeteksi'],
        ['code' => 'dana', 'title' => 'DANA', 'caption' => 'Dompet digital DANA'],
        ['code' => 'ovo', 'title' => 'OVO', 'caption' => 'Pembayaran cepat OVO'],
    ];
@endphp
                ...
                <div class="rounded-2xl border border-white/5 bg-[#0f0f12] p-4 lg:p-6 text-white space-y-6">
                    ...
                    <div class="space-y-4 rounded-2xl border border-white/5 bg-[#1a1a1e] p-5">
                        ...
                        <div class="grid gap-3 sm:grid-cols-2">
                            @foreach($paymentOptions as $option)
                                <button type="button" data-payment-method="{{ $option['code'] }}" class="topup-payment-card rounded-2xl border border-white/5 bg-[#111114] px-4 py-3 text-left transition hover:border-rose-500/60">
                                    <p class="text-sm font-semibold">{{ $option['title'] }}</p>
                                    <p class="text-xs text-gray-400">{{ $option['caption'] }}</p>
                                </button>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button" class="rounded-2xl bg-rose-600 px-6 py-3 text-sm font-semibold hover:bg-rose-500">Bayar Sekarang</button>
                        </div>
                    </div>
                </div>
            </section>
