        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center">
            ...
            <div class="bg-[#27272A] rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xl">
                ...
                <div class="mb-4 p-4 bg-green-500/10 border border-green-500 rounded-lg">
                    <p class="text-green-500 text-sm sm:text-base font-semibold mb-2">✓ Pesan berhasil dikirim!</p>
                    <p class="text-gray-300 text-xs sm:text-sm mb-3">Terima kasih telah menghubungi kami. Klik tombol di bawah untuk melanjutkan ke WhatsApp:</p>
