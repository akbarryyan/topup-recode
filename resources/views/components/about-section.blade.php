    ...
    <div class="max-w-6xl mx-auto relative z-10">
        ...
        <div class="text-center mb-12 md:mb-16">
            <div class="inline-block mb-4">
                <h1 class="text-4xl md:text-5xl font-black text-white mb-2">
                    {{ \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') }}
                </h1>
                <div class="h-1 bg-linear-to-r from-transparent via-yellow-500 to-transparent rounded-full"></div>
            </div>
        ...
        <div id="aboutPreview" class="bg-[#111111] rounded-2xl p-6 md:p-8 border border-white/5 mb-8">
            <p class="text-gray-300 text-base md:text-lg leading-relaxed line-clamp-4">
                {!! \App\Models\WebsiteSetting::get('about_preview', 'Kebutuhan akan layanan top up game dan pembelian voucher game menjadi semakin penting bagi para pemain di berbagai platform. ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' hadir sebagai solusi terbaik untuk memenuhi semua kebutuhan tersebut. ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' dikenal sebagai tempat top up game termurah dan terpercaya yang menghadirkan kemudahan, kecepatan, serta keamanan bagi setiap pengguna.') !!}
            </p>
        </div>
        ...
        <div id="aboutFull" class="hidden space-y-8">
            ...
            <div class="bg-[#111111] rounded-2xl p-6 md:p-8 border border-white/5">
                <div class="text-gray-300 text-base md:text-lg leading-relaxed space-y-4">
                    {!! \App\Models\WebsiteSetting::get('about_full', '<p>Kebutuhan akan layanan top up game dan pembelian voucher game menjadi semakin penting bagi para pemain di berbagai platform. ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' hadir sebagai solusi terbaik untuk memenuhi semua kebutuhan tersebut. ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' dikenal sebagai tempat top up game termurah dan terpercaya yang menghadirkan kemudahan, kecepatan, serta keamanan bagi setiap pengguna.</p><p>Dengan berbagai pilihan game populer, mulai dari Mobile Legends, PUBG Mobile, Free Fire, Genshin Impact, Valorant, hingga Roblox, ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' memastikan setiap gamer bisa mendapatkan mata uang digital, voucher, maupun item premium dengan harga kompetitif. Tidak hanya itu, ' . \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') . ' juga mendukung beragam metode pembayaran modern seperti e-wallet, transfer bank, hingga pulsa, sehingga memudahkan siapa pun untuk bertransaksi kapan saja dan di mana saja.</p>') !!}
                </div>
            </div>
            ...
            <div class="bg-[#111111] rounded-2xl p-6 md:p-8 border border-white/5">
                <h2 class="text-white text-2xl md:text-3xl font-bold mb-8 text-center">
                    Mengapa Memilih <span class="text-yellow-500">{{ \App\Models\WebsiteSetting::get('website_name', 'NVD STORE') }}</span>?
                </h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-green-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-yellow-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-yellow-500 to-yellow-600 rounded-lg flex items-center justify-center">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-blue-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-purple-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-red-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center">
                    ...
                    <div class="group bg-[#1a1a1a] hover:bg-[#1f1f1f] p-6 rounded-xl border border-white/5 hover:border-indigo-500/30 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            <div class="shrink-0 w-12 h-12 bg-linear-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center">
        ...
        <div class="mt-8 text-center">
            <button id="toggleAbout" class="group inline-flex items-center gap-2 bg-linear-to-b from-yellow-400 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 text-black font-bold px-8 py-3 rounded-xl transition-all duration-300 shadow-[0_5px_0_rgba(161,98,7,0.8),inset_0_1px_0_rgba(255,255,255,0.3)] hover:shadow-[0_2px_0_rgba(161,98,7,0.8),inset_0_1px_0_rgba(255,255,255,0.3)] hover:translate-y-[3px] active:translate-y-[5px] active:shadow-[0_0px_0_rgba(161,98,7,0.8)]">
                <span id="toggleText">{{ app()->getLocale() === 'en' ? 'Read More' : 'Baca Selengkapnya' }}</span>
                <i id="toggleIcon" class="ri-arrow-down-s-line text-xl transition-transform"></i>
            </button>
        </div>
    </div>
</div>
